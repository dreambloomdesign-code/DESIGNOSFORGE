...
class GitHubManager:
    ...
    def release_plan(self, version="v1.6.0"):
    ...
    def pr_template(self, version="v1.6.0"):
        return "\n".join([
            f"# Release DESIGNOSFORGE {version}",
            "",
            "## Summary",
            "- Add v1.6 training-aware aesthetic memory, project-context routing, corpus audit, and case recommendation.",
